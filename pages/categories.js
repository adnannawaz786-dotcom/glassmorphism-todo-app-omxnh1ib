        ...
        <div className="relative z-10 container mx-auto px-4 py-8">
                      ...
                      <div className="flex gap-2 mt-2">
                        {colorOptions.map((color) => (
                          <button
                            ...
                            className={`w-8 h-8 rounded-full border-2 transition-all ${newCategory.color === color ? 'border-white scale-110' : 'border-white/30'
                              }`}
          ...
          {categories.length === 0 && (
            ...
            >
              ...
              <p className="text-white/70 text-lg">No categories found. Please add some categories.</p>
            </motion.div>
          )}
                    ...
                    <div className="flex gap-2 mt-2">
                      {colorOptions.map((color) => (
                        <button
                          ...
                          className={`w-8 h-8 rounded-full border-2 transition-all ${editingCategory.color === color ? 'border-white scale-110' : 'border-white/30'
                            }`}
                          style={{ backgroundColor: color }}
                        />
                      ))}
            ...
            <AlertDialogContent className="bg-black/40 backdrop-blur-xl border border-white/20 text-white">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="text-white/70">
                  Are you sure you want to delete this category? Todos in this category will be moved to "Personal".
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
